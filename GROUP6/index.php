      ...
      <nav class="navbar navbar-expand-md navbar-light pt-5 pb-4">
        <div class="container-xxl">
          ...
          <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="registerview.php">Sign up</a>
              </li>
        ...
        <div class="container-lg">
          ...
          <div class="col-md-5 text-center d-none d-md-block">
              ...
              <span class="tt" data-bs-placement="bottom" title="Net Ninja Pro book cover">
                <img src="https://static.onecms.io/wp-content/uploads/sites/20/2020/12/08/best-books-2020.jpg" class="img-fluid img-cus" alt="ebook">
              </span>
            </div>
          </div>
        </div>
